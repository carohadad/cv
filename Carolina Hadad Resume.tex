...
\item World Economic Forum Latam, Riviera Maya, Mexico \hfill \textbf{May 2015} \vspace{2mm} \\
...
\item Ice Cream coded in React(In progress): \href{https://github.com/carohadad/icecream-world}{code}.
\end{list2}
...
\item Scholarship Chair  @ Latinity Conference Chile \& Per\'u \hfill \textbf{Nov 2015 \& Mar 2017}\\
...
\textbf{Programming Languages}: Ruby, Python, Elm,  JavaScript, C\#, Erlang, C/C++, Prolog, Haskell, Smalltalk. \vspace{-2mm}
